                                                    ...
                                                    <div class="mt-3 grid gap-3 md:grid-cols-2 xl:grid-cols-7">
                                                        @foreach (range(1, $battleSlotCount) as $slot)
                                                            <div class="grid gap-2 rounded-lg border border-slate-800 bg-slate-900/45 p-3">
                                                                ...
                                                                <label class="grid gap-1">
                                                                    <span class="text-[11px] uppercase tracking-[0.14em] text-slate-500">Winner</span>
                                                                    <select name="result_{{ $slot }}" class="rounded-lg border border-slate-700 bg-slate-950/70 px-3 py-2 text-sm text-slate-100 focus:border-amber-500 focus:outline-none">
                                                                        <option value="">-</option>
                                                                        <option value="1" @selected((string) $match->{'result_'.$slot} === '1')>{{ $match->player1->user->nickname }}</option>
                                                                        <option value="2" @selected((string) $match->{'result_'.$slot} === '2')>{{ $match->player2?->user->nickname }}</option>
                                                                    </select>
                                                                </label>
                                                                <label class="grid gap-1">
                                                                    <span class="text-[11px] uppercase tracking-[0.14em] text-slate-500">Finish</span>
