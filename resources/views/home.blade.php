<x-layouts.public :title="'BBX La Union'">
    <section class="mb-12">
        <div class="relative px-4 pt-10 pb-8 sm:px-6 sm:pt-12 sm:pb-10 lg:px-10">
            <div class="mx-auto max-w-4xl text-center">
                ...
                <p class="mt-2 text-[clamp(2rem,8vw,5.25rem)] font-black uppercase leading-[0.95] tracking-[0.08em] text-cyan-100 drop-shadow-[0_0_14px_rgba(34,211,238,0.6)] sm:tracking-[0.12em]">
                    WELCOME TO SEASON 2
                </p>
                <p class="mx-auto mt-4 max-w-2xl px-2 text-sm font-medium text-slate-300 sm:text-base">
                    Wala parin Kaming DTI Permit.
                </p>
                <div class="mt-6 flex w-full flex-wrap items-center justify-center gap-3">
                    <a href="{{ route('home') }}#register" class="w-full rounded-none border border-amber-500/70 bg-amber-500/10 px-4 py-2 text-center text-xs font-semibold uppercase tracking-wider text-amber-200 transition hover:bg-amber-500/20 sm:w-auto">
                        Register Now
                    </a>
                    <a href="{{ route('home') }}#players" class="w-full rounded-none border border-slate-600 bg-slate-900/75 px-4 py-2 text-center text-xs font-semibold uppercase tracking-wider text-slate-200 transition hover:border-cyan-400 hover:text-cyan-200 sm:w-auto">
                        View Players
                    </a>
                </div>
            </div>
    ...
    <section class="mb-12 grid gap-5 lg:grid-cols-2">
        <aside class="w-full">
            <div class="h-full bg-slate-900/75 p-5 ring-1 ring-slate-700/65">
        ...
        <aside class="w-full">
            <div data-ranking-rail class="h-full bg-slate-900/75 p-5 ring-1 ring-slate-700/65">
                <div class="mb-3 flex items-center justify-between">
    ...
    <section class="mb-12 grid gap-5 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
            ...
            <div class="grid gap-2.5">
                @forelse ($awardLeaders as $row)
                    <div class="relative overflow-hidden bg-gradient-to-b from-slate-950/85 to-slate-950/70 px-3 py-3 ring-1 ring-slate-800/70">
                        <div class="grid min-h-[112px] grid-cols-1 gap-3 sm:grid-cols-[minmax(0,1fr)_86px] sm:items-center">
                            <div class="pr-1">
                            ...
                            <div class="border-t border-slate-800/80 pt-3 text-left sm:h-full sm:border-t-0 sm:border-l sm:pl-3 sm:pt-0 sm:text-right">
    ...
    <section id="register" class="mt-12 bg-slate-900/80 p-6 ring-1 ring-amber-400/35">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('login') }}" class="w-full rounded-none border border-amber-500/70 bg-amber-500/10 px-4 py-2 text-center text-xs font-semibold uppercase tracking-wider text-amber-200 hover:bg-amber-500/20 sm:w-auto">
                Go To Login
            </a>
        </div>
    </section>
        ...
        <div class="max-h-[90vh] w-full max-w-2xl overflow-y-auto border border-cyan-400/60 bg-slate-950 p-4 sm:p-5">
            <div class="mb-4 flex items-start justify-between gap-3">
                <div>
                    ...
                    <h3 class="mt-1 text-xl font-extrabold uppercase tracking-wide text-white sm:text-2xl" data-event-modal-title></h3>
                </div>
